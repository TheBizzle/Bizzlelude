...
import Data.Eq(Eq((==), (/=)))
import Data.Foldable(and, any, all, Foldable(elem, fold, foldMap, foldr, foldr', foldl, foldl', foldr1, foldl1, null, maximum, minimum, sum, product), find, foldlM, for_, maximumBy, minimumBy, or, sequenceA_)
